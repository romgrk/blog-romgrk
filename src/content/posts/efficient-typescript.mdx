...
The greatest benefit of this kind of error-handling is that it encodes failure directly in the type-system, so you know at compile-time if you haven't dealt with a failure.
