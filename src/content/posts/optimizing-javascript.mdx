...
Let's say we are a merchant that sometimes needs to add tags to its product list. We know from experience that our tags are usually empty. Knowing that information, we can specialize our function for that case:
