...
<Aside title="Terminology across JS engines">
I have used the word "shape" for this concept, but be aware that you may also find *"hidden class"* or *"map"* used to describe the same concept, depending on the engine.
</Aside>
...
- The deoptexplorer-vscode extension allows you to load V8/chromium log files to understand when your code is triggering deoptimizations, such as when you pass different shapes to a function.  
