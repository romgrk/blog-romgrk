...
As an anecdote, I had a case where we were able to [reduce the runtime of a functiom from 5 seconds to 22 milliseconds](https://github.com/mui/mui-x/pull/9200) by switching out an array with a linked list!
