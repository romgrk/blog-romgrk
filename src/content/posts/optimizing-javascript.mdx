...
<Aside title="Number representation">
 Engines can usually encode integers as values. For example, V8 represents integers as compact [Smi](https://medium.com/fhinkel/v8-internals-how-small-is-a-small-integer-e0badc18b6da) (SMall Integer) values, and JSC uses [double tagging](https://ktln2.org/2020/08/25/javascriptcore/) to pass numbers by value, as SpiderMonkey does. The rest is passed as pointers to more complex representations.
</Aside>
