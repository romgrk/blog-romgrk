...
Easier said than done but: **create all your objects with the exact same shape**. Even just inverting two fields destroys your performance. For example, here are [simple cases](https://github.com/facebook/react/pull/28569) I <mark title="see section 10 for how">found</mark> in React's codebase, but they already had a [much higher impact case](https://v8.dev/blog/react-cliff) of the same problem a few years ago.
